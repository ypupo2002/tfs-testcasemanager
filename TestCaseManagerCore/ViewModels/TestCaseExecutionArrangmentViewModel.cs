// <copyright file="TestCaseExecutionArrangmentViewModel.cs" company="CodePlex">
...
namespace TestCaseManagerCore.ViewModels
{
    ...
    public class TestCaseExecutionArrangmentViewModel : BaseNotifyPropertyChanged
    {
        ...
        {
            List<TestCase> suiteTestCases = TestCaseManager.GetAllTestCaseFromSuite(suiteId);
            this.CurrentSuite = TestSuiteManager.GetTestSuiteById(suiteId) as IStaticTestSuite;
